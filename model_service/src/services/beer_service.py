...
from src.schema.beer_exceptions import (
...
class BeerService:
    ...
    def __init__(self, llm_service: Optional[LLMService] = None):
        ...
        Args:
            llm_service: LLM服务实例，如果不提供则创建新实例
        """
        if llm_service is None:
            from src.services.llm_service import llm_service as default_llm_service
            self.llm_service = default_llm_service
        else:
            self.llm_service = llm_service
        
        # 注册啤酒模板
        register_beer_templates(self.llm_service.prompt_manager)
    ...
    def get_recommendation(
        ...
        try:
            ...
            result = self.llm_service.chat_with_template(
    ...
    def chat(
        ...
        try:
            ...
            messages = self.llm_service.create_conversation(system_prompt)
            
            if request.conversation_history:
                for msg in request.conversation_history:
                    messages = self.llm_service.add_to_conversation(
                        messages,
    ...
    def list_templates(self) -> List[str]:
        ...
        try:
            ...
            available_templates = [
                ...
                if t in self.llm_service.list_templates()
            ]
...
beer_service = BeerService(global_llm_service)
